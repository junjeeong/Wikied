  ...
  return (
    <div className="flex gap-[10px]">
      <button
        ...
        className="rounded-[10px] w-[45px] h-[45px] text-2lg text-gray-400 bg-gray-50 shadow-[0_4px_20px_#00000014] bg-[url('/icon/ic_arrow_bottom2.svg')] bg-no-repeat bg-center transform rotate-90"
      ></button>
      {pageArr.map((page) => (
        <button
          type="button"
